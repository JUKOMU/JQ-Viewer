...
[![Version](https://img.shields.io/badge/Version-1.4.6-brightgreen.svg)](https://github.com/JUKOMU/JQ-Viewer/releases)
...
| 正在进行 | 进度 | 说明 |
| --- | --- | --- |
| Desktop/桌面版开发 | 70% | 功能基本开发完成，还差人工验收 |
| 接入 PicaComic | 10% | 可行性验证通过 |
...
> 本人是今年的毕业生，因为种种原因，还没有找到工作，也是比较焦虑吧，心态有点不对劲了。总之，该去和生活对线了。2026.9.17
