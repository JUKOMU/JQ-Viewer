...
public class ExportForegroundService extends Service {
    ...
    private static final String ACTION_STOP = "io.github.jukomu.EXPORT_FOREGROUND_STOP";
    ...
    /**
     * Publishes a progress snapshot to the process-owned foreground service.
     */
    ...
    private void flushNow() {
        ...
        try {
            startForeground(NotificationIds.EXPORT_FOREGROUND, buildNotification(snapshot));
    ...
    private PendingIntent createLaunchIntent() {
        ...
        return PendingIntent.getActivity(
            this,
            NotificationIds.EXPORT_FOREGROUND,
            intent,
