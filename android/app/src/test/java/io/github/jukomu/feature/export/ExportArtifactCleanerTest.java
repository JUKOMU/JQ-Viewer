...
public class ExportArtifactCleanerTest {
    ...
    public void stagingCleanupCountsBeforeDeletingOnlyTheControlledChild() throws Exception {
        ...
        try {
            ...
            assertEquals(3L, ExportArtifactCleaner.cleanupStagingDirectory(cacheRoot, "export-1"));
    ...
    public void stagingCleanupRejectsTraversal() throws Exception {
        ...
        try {
            assertThrows(Exception.class,
                () -> ExportArtifactCleaner.cleanupStagingDirectory(cacheRoot, "../outside"));
        } finally {
            deleteRecursively(cacheRoot);
        }
    }
